...
func NewHandler(usecase interfaces.FileUsecase, infoService interfaces.InfoServiceInterface, editor interfaces.EditorUsecase, apiKey, urlPrefix string) *Handler {
